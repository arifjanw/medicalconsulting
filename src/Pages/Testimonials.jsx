     ...
     <main>
      <section className=" text-gray-600 py-20 px-6"style={{ backgroundColor: "#e8fcf8",}}>
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl font-bold">Pharmacists rely on MedEssist</h1>
          <p className="text-4xl font-bold">Pharmacists rely on MedEssist</p>
          Hear from pharmacy owners and managers, just like you!
        </div>
      </section>
